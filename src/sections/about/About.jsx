  ...
  return (
    <Container id="about">
      <div>
        ...
        <Description>
          Au cours de mes études, j'ai eu l'opportunité de me familiariser avec divers outils technologiques. J'ai notamment développé des compétences en <strong>React</strong>, <strong>NodeJS</strong> et d'<strong>autres technologies front-end</strong>. 
          <br /><br />
